...
export const JOB_SOURCES: SeedJobSource[] = [
  ...
  // Verified additions: YC, a16z, Sequoia and Benchmark portfolio companies,
  // resolved from portfolio lists to their official ATS board tokens and
  // confirmed to return postings.
  { companyName: 'Checkr', provider: 'GREENHOUSE', boardToken: 'checkr' },
  { companyName: 'Mixpanel', provider: 'GREENHOUSE', boardToken: 'mixpanel' },
  { companyName: 'Contentful', provider: 'GREENHOUSE', boardToken: 'contentful' },
  { companyName: 'Lithic', provider: 'GREENHOUSE', boardToken: 'lithic' },
  { companyName: 'Modern Health', provider: 'GREENHOUSE', boardToken: 'modernhealth' },
  { companyName: 'Alloy', provider: 'GREENHOUSE', boardToken: 'alloy' },
  { companyName: 'Ginkgo Bioworks', provider: 'GREENHOUSE', boardToken: 'ginkgobioworks' },
  { companyName: 'Coursera', provider: 'GREENHOUSE', boardToken: 'coursera' },
  { companyName: 'Udemy', provider: 'GREENHOUSE', boardToken: 'udemy' },
  { companyName: 'MasterClass', provider: 'GREENHOUSE', boardToken: 'masterclass' },
  { companyName: 'Outschool', provider: 'GREENHOUSE', boardToken: 'outschool' },
  { companyName: 'Life360', provider: 'GREENHOUSE', boardToken: 'life360' },
  { companyName: 'Nextdoor', provider: 'GREENHOUSE', boardToken: 'nextdoor' },
  { companyName: 'Marqeta', provider: 'GREENHOUSE', boardToken: 'marqeta' },
  { companyName: 'Epic Games', provider: 'GREENHOUSE', boardToken: 'epicgames' },
  { companyName: 'Riot Games', provider: 'GREENHOUSE', boardToken: 'riotgames' },
  { companyName: 'Cockroach Labs', provider: 'GREENHOUSE', boardToken: 'cockroachlabs' },
  { companyName: 'Starburst', provider: 'GREENHOUSE', boardToken: 'starburst' },
  { companyName: 'Dremio', provider: 'GREENHOUSE', boardToken: 'dremio' },
  ...
  { companyName: 'Cerebras', provider: 'ASHBY', boardToken: 'cerebras' },
  { companyName: 'LangChain', provider: 'ASHBY', boardToken: 'langchain' },
  { companyName: 'Harvey', provider: 'ASHBY', boardToken: 'harvey' },
  { companyName: 'Crusoe', provider: 'ASHBY', boardToken: 'crusoe' },
  { companyName: 'Baseten', provider: 'ASHBY', boardToken: 'baseten' },
  { companyName: 'Supabase', provider: 'ASHBY', boardToken: 'supabase' },
  { companyName: 'Writer', provider: 'ASHBY', boardToken: 'writer' },
  { companyName: 'Sardine', provider: 'ASHBY', boardToken: 'sardine' },
  { companyName: 'Render', provider: 'ASHBY', boardToken: 'render' },
  { companyName: 'Modal', provider: 'ASHBY', boardToken: 'modal' },
  { companyName: 'RunPod', provider: 'ASHBY', boardToken: 'runpod' },
  { companyName: 'Middesk', provider: 'ASHBY', boardToken: 'middesk' },
  { companyName: 'Column', provider: 'ASHBY', boardToken: 'column' },
  { companyName: 'Persona', provider: 'ASHBY', boardToken: 'persona' },
  { companyName: 'Railway', provider: 'ASHBY', boardToken: 'railway' },
  { companyName: 'Pinecone', provider: 'ASHBY', boardToken: 'pinecone' },
  { companyName: 'Neon', provider: 'ASHBY', boardToken: 'neon' },
]
